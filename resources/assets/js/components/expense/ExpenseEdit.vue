            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div v-if="success" class="alert alert-success" role="alert">
                        <strong>Well done!</strong> Expense has been updated successfully.
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div v-bind:class="[(error && errors.name)? has_error:'', form_group]">
                                ...
                                <input type="text" v-model="expense.name" id="name" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div v-bind:class="[(error && errors.description)? has_error:'', form_group]">
                                ...
                                <textarea v-model="expense.description" id="description" class="form-control"></textarea>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" @click="updateRecode" class="btn btn-primary">Update Expense</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
...
<script type="text/javascript">
    ...
    export default{
        ...
        methods:{
            updateRecode(){
                axios.post("expense/" + this.expense.id,{
                    name: this.expense.name,
                    description: this.expense.description,
                    _method: 'PUT'
                })
                .then(data => {
                    this.$emit('expenseUpdated', data);
