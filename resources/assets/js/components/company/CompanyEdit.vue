            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div v-if="success" class="alert alert-success" role="alert">
                        <strong>Well done!</strong> Company has been updated successfully.
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div v-bind:class="[(error && errors.name)? has_error:'', form_group]">
                                <label for="name" class="required">Name</label>
                                <input type="text" v-model="company.name" id="name" class="form-control">
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" @click="updateRecode" class="btn btn-primary">Update Company</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
...
<script type="text/javascript">
    ...
    export default{
        ...
        methods:{
            updateRecode(){
                axios.post("company/" + this.company.id,{
