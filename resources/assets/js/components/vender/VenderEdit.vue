<template>
    <div class="modal fade" id="editVenderModal" tabindex="-1" role="dialog" aria-labelledby="editVenderModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" @click="clearModel" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel">Edit Vender</h4>
                </div>

                <div class="modal-body">
                    <div v-if="success" class="alert alert-success" role="alert">
                        <strong>Well done!</strong> Vender has been updated successfully.
                    </div>
                    <div class="row">
                        <div class="col-md-6">
                            <div v-bind:class="[(error && errors.name)? has_error:'', form_group]">
                                <label for="name" class="required">Name</label>
                                <input type="text" v-model="vender.name" id="name" class="form-control">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div v-bind:class="[(error && errors.description)? has_error:'', form_group]">
                                ...
                                <textarea v-model="vender.description" id="description" class="form-control"></textarea>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" @click="updateRecode" class="btn btn-primary">Update Vender</button>
                </div>
            </div>
            <!-- /.modal-content -->
        </div>
...
<script type="text/javascript">
    ...
    export default{
        ...
        methods:{
            updateRecode(){
                axios.post("vender/" + this.vender.id,{
                    'name': this.vender.name,
                    'description': this.vender.description,
                    '_method': 'PUT'
                })
                .then(data => {
                    this.$emit('venderUpdated', data);
                    this.name='';
                    this.description='';
