<template>
    <div class="modal fade" id="addVenderModal" tabindex="-1" role="dialog" aria-labelledby="addVenderLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">&times;</button>
                    <h4 class="modal-title" id="myModalLabel">Add New Vender</h4>
                </div>
                <div class="modal-body">
                    <div v-if="success" class="alert alert-success" role="alert">
                        <strong>Well done!</strong> Vender has been added successfully.
                    </div>
                    <div class="row">
                        <div class="col-md-6">
        ...
        methods:{
            addRecode(){
                ...
                .then(response => {
                    ...
                    this.$emit('venderCreated', response);
